...
2. Cross-reference with live resources via CloudFormation MCP to confirm what's deployed
...
4. If CloudWatch MCP is available, include recent performance characteristics
