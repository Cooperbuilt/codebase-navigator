...
After installing the plugin, you'll need to configure MCP servers for your environment. See [docs/SETUP-GUIDE.md](docs/SETUP-GUIDE.md) for a step-by-step guide. You'll need:
